...
class QuadPath extends Motion
{
	...
	{
		_points = new Array<Vector2>();
		_curve = new Array<Vector2>();
	...
	private function curveLength(start:Vector2, control:Vector2, finish:Vector2):Float
	{
		var a:Vector2 = Util.point,
			b:Vector2 = Util.point2;
	...
	private var _curve:Array<Vector2>;
	private var _curveT:Array<Float>;
	private var _curveD:Array<Float>;

	// Curve points.
	private var _a:Vector2;
	private var _b:Vector2;
	private var _c:Vector2;
}
