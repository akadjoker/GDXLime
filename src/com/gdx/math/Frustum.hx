...
class Frustum {
	...
	public static function GetPlanes(transform:Matrix4):Array<Plane> {
		var frustumPlanes = [];
	...
	inline public static function GetPlanesToRef(transform:Matrix4, frustumPlanes:Array<Plane>):Array<Plane> {
		// Near
