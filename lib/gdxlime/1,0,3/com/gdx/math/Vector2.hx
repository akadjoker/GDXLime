...
class Vector2 {
	...
	inline public function equalsWithEpsilon(otherVector:Vector2):Bool 
	{
    ...
    inline public static function Transform(vector:Vector2, transformation:Matrix4):Vector2 {
