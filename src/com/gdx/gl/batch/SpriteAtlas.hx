...
private var bottom:Float;
 ...
 private var colorAttribute :Int = 2;
	...
	public function new(capacity:Int ,tex:Texture,blend:Int=0) 
	{
...
imageUniform = GL.getUniformLocation (shaderProgram, "uImage0");
    ...
    GL.bufferData(GL.ARRAY_BUFFER,  new Float32Array(numVerts), GL.STATIC_DRAW);
    ...
    public    function Render( x:Float, y:Float,  srcX:Int,  srcY:Int,  srcWidth:Int,  srcHeight:Int)
	{
...
this.currentBatchSize++;
	...
	public  inline  function RenderTile(x:Float,y:Float,width:Float,height:Float,clip:Clip,flipx:Bool,flipy:Bool)
{
...
public  inline function RenderTileScale(x:Float,y:Float,width:Float,height:Float,scaleX:Float,scaleY:Float,clip:Clip,flipx:Bool,flipy:Bool)
{
...
public  inline  function RenderFont(x:Float,y:Float,scale:Float,clip:Clip,flipx:Bool,flipy:Bool,r:Float,g:Float,b:Float,a:Float)
{
...
public  inline  function RenderFontScale(texture:Texture,x:Float,y:Float,scaleX:Float,scaleY:Float,clip:Clip,flipx:Bool,flipy:Bool,r:Float,g:Float,b:Float,a:Float)
{
...
this.currentBatchSize++;
   ...
   public function Blt( src:Clip,dst:Clip,flipX:Bool,flipY:Bool)
	{
...
this.currentBatchSize++;
	...
	public  function RenderClip( x:Float, y:Float,c:Clip,flipX:Bool,flipY:Bool)
	{
...
this.currentBatchSize++;
	...
	public  inline  function drawVertexMatrix(
...
public  inline  function renderVertexRotateScale(clip:Clip, X:Float, Y:Float, spin:Float,size:Float=0)
{
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
	...
	public  inline function drawVertexFlip(
		 ...
		 y4:Float,
 	     clip:Clip, 
	     r:Float,g:Float,b:Float,a:Float,flipX:Bool,flipY:Bool)
	{
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
	...
	public    function RenderScaleRotateColorAlpha(x:Float, y:Float,ScaleX:Float,ScaleY:Float,Rotation:Float,r:Float,g:Float,b:Float,Alpha:Float)
	{
 ...
 r,g,b, Alpha);
	...
	public    function RenderScaleRotateAlpha(x:Float, y:Float,Scale:Float,Rotation:Float,Alpha:Float)
	{
 ...
 TX1 * CosT - TY2 * SinT + x,TX1 * SinT + TY2 * CosT + y,
  ...
  1, 1, 1, Alpha);
	...
	public  inline  function drawVertexTexture(
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
    ...
    currentBatchSize++;
		...
		public    function RenderScaleRotateClipColorAlpha(x:Float, y:Float,ScaleX:Float,ScaleY:Float,Rotation:Float,clip:Clip,r:Float,g:Float,b:Float,Alpha:Float)
	{
 ...
 r,g,b, Alpha);
	...
	public  inline  function drawVertexTextureClip(
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
	...
	//******************
	public    function RenderScaleRotateClipFlipColorAlpha(x:Float, y:Float,ScaleX:Float,ScaleY:Float,Rotation:Float,clip:Clip,flipx:Bool,flipy:Bool,r:Float,g:Float,b:Float,Alpha:Float)
	{
 ...
 r,g,b, Alpha);
	...
	public    function RenderScaleRotateClipFlipColorAlphaOffset(x:Float, y:Float,xOffset:Float,yOffset:Float,ScaleX:Float,ScaleY:Float,Rotation:Float,clip:Clip,flipx:Bool,flipy:Bool,r:Float,g:Float,b:Float,Alpha:Float)
	{
 ...
 r,g,b, Alpha);
	...
	public  inline  function drawVertexTextureClipFlip(
		 x1:Float,
		 y1:Float,
		 x2:Float,
		 y2:Float,
...
vertices[index++] = r;vertices[index++] = g;vertices[index++] = b;vertices[index++] = a;
	...
	//******************
	public    function RenderNormal( x:Float, y:Float)
	{
